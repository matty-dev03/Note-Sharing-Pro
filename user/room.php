		...
		<div class="col-lg-12">
            <div class="panel panel-default" style="height:50px;">
				...
				<div class="pull-right" style="margin-right:10px; margin-top:7px;">
					<span id="user_details" style="font-size:18px; position:relative; top:2px;"><strong>Members: </strong><span class="badge"><?php echo mysqli_num_rows($r1); ?></span></span>
				...
				<div class="showme hidden" style="position: absolute; left:570px; top:20px;">
					...
					<?php
						$rm="select * from chat_member left join tbl_student on tbl_student.user_id=chat_member.userid where chat_member.chatroomid='$id'";
						$result=$obj->executequery($rm);
						while($rmrow=mysqli_fetch_array($result)){
							?>
							<span>
							<?php
								$creq="select * from chatroom where chatroomid='$id'";
								$result1=$obj->executequery($rm);
								$crerow=mysqli_fetch_array($result1);
