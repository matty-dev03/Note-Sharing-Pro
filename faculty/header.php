    ...
    <div class="container-fluid container-xl position-relative d-flex align-items-center">
      ...
      <div class="main_nav">
            <ul class="main_nav_list">
                ...
                <li class="main_nav_item"><a href="view.php">Documents</a></li>
                <li class="main_nav_item"> <a href="documentupload.php" class="nav_link">Document Upload</a>
                        <!-- <img src="coin_img.png" alt="Coin" class="coin_image">
                      Coin Remaining: <?php echo $row['coin_count'];?> -->
                </li>
