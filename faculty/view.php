...
<head>
    ...
    <link href="docview/lib/animate/animate.min.css" rel="stylesheet">
    <link href="docview/docview/lib/owlcarousel/assets/owl.carousel.min.css" rel="stylesheet">

    <!-- Customized Bootstrap Stylesheet -->
    <link href="docview/docview/css/style.css" rel="stylesheet">
        ...
        <div class="row px-xl-5">
            ...
            <div class="col-lg-3 col-md-4">
                ...
                <div class="bg-light p-4 mb-30">
                    <form>
                        <?php
                        $sql = "select distinct* from tbl_course";
                        ...
                        ?>
                        <button class="btn-info"><a href="index.php" style="color: #0a0a0a;">Return Home</a></button>
            ...
            <div class="col-lg-9 col-md-8">
                <div class="row pb-3">
                    ...
                    <?php
                    $sql1 = "select * from tbl_document d inner join tbl_subject s on d.subject=s.subject_id where status='Accept'";
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6 pb-1" >
                                ...
                                <div class="product-item bg-light mb-4">
                                    ...
                                    <div class="text-center py-4">
                                        ...
                                        <h6><?php echo $disp['subject_name']; ?></h6>
