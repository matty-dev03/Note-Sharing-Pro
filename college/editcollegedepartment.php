...
$obj = new dboperation();
$department_id=$_GET["college_department_id"];
          ...
          <div class="col-md-7 py-5">
            <div class="card">
              <div class="card-body">
                ...
                <form action="collegedepartmenteditaction.php" method="post" enctype="multipart/form-data">
                  <div class="row">
                    <div class="col-md-12">
                    <?php
                    ...
                    ?>
                      ...
                      <input type="hidden" class="form-check-input" type="checkbox" name="department[]" value="<?php echo $display["department_id"]; ?>" id="department_<?php echo $display["department_id"]; ?>">
