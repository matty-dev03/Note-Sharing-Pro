...
INNER JOIN tbl_subject sb ON d.subject_id = sb.subject_id 
        ...
        <div class="row">
            <div class="col-11 d-flex justify-content-end">
                <button type="button" class="btn btn-primary mr-1 mb-3"
                    onclick='window.location.href="Registration.php"'>Add New</button>
            </div>
                                        ...
                                        <td>
                                            ...
                                            <div class="popup" data-popup="popup-<?php echo $i; ?>">
                                                <div class="popup-content">
                                                    ...
                                                    <a class="close-button" data-popup-close="popup-<?php echo $i; ?>" href="javascript:void(0)">x</a>
                                                </div>
                                            </div>
